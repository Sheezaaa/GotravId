...
<html>
	<head>
		<title>Gotrav ID | Package Details</title>
		<meta charset="utf-8" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<header id="header" class="alt">
					<a href="/" class="logo"><strong>Gotrav ID</strong> <span>Website</span></a>
					<nav>
						<a href="#menu">Menu</a>
					</nav>
				</header>
								...
								<div class="inner">
									...
									<div class="table-responsive">
							          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
							               <tbody>
							                    <tr>
							                         <td width="275px">Check-in</td>
							                         <td>Donec dapibus semper sem, ac ultrices sem sagittis ut. Donec sit amet erat elit, sed pellentesque odio. In enim ligula, euismod a adipiscing in, laoreet quis turpis. Ut accumsan dignissim rutrum.</td>
							                    </tr>

							                    <tr>
							                         <td width="275px">Check-out</td>
							                         <td>Donec dapibus semper sem, ac ultrices sem sagittis ut. Donec sit amet erat elit, sed pellentesque odio. In enim ligula, euismod a adipiscing in, laoreet quis turpis. Ut accumsan dignissim rutrum.</td>
							                    </tr>

							                    <tr>
							                         <td width="275px">Pets</td>
							                         <td>Not allowed</td>
							                    </tr>

							                    <tr>
							                         <td width="275px">Policies</td>
							                         <td>Donec dapibus semper sem, ac ultrices sem sagittis ut. Donec sit amet erat elit, sed pellentesque odio. In enim ligula, euismod a adipiscing in, laoreet quis turpis. Ut accumsan dignissim rutrum. <br>Donec dapibus semper sem, ac ultrices sem sagittis ut. Donec sit amet erat elit, sed pellentesque odio. In enim ligula, euismod a adipiscing in, laoreet quis turpis. Ut accumsan dignissim rutrum.</td>
							                    </tr>

							                    <tr>
							                         <td width="275px">Fees</td>
							                         <td>Donec dapibus semper sem, ac ultrices sem sagittis ut. Donec sit amet erat elit, sed pellentesque odio. In enim ligula, euismod a adipiscing in, laoreet quis turpis. Ut accumsan dignissim rutrum. <br>Donec dapibus semper sem, ac ultrices sem sagittis ut. Donec sit amet erat elit, sed pellentesque odio. In enim ligula, euismod a adipiscing in, laoreet quis turpis. Ut accumsan dignissim rutrum.</td>
							                    </tr>
							               </tbody>
							          </table>
										...
										<form method="post" action="#">
											<div class="fields">
												...
												<div class="field quarter">
													...
													<input type="text" name="from" id="from" placeholder="23.06.2020" />
												</div>

												<div class="field half quarter">
													<label for="to">To</label>
													<input type="text" name="to" id="to" placeholder="30.06.2020" />
												</div>
												<div class="field">
				...
				<footer id="footer">
					<div class="inner">
						<ul class="icons">
							...
							<li><a href="https://www.instagram.com/gotrav.idn/" class="icon alt fa-instagram"><span class="label">Instagram</span></a></li>
                            
						</ul>
						<ul class="copyright">
							<li>Copyright © 2023 Gotrav ID. All Rights Reserved</li>
						</ul>
					</div>
				</footer>
