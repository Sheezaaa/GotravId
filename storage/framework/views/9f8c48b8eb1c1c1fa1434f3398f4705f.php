							...
							<section class="tiles">
								<article>
									...
									<header class="major">
										...
										<h3>Limelight Lodge</h3>

										<p><strong>$300 - $400</strong></p>
										...
										<div class="major-actions">
											<a href="/package-details" class="button small next">View Package</a>
										</div>
									</header>
								</article>
							...
							<section class="tiles">
								<article>
									...
									<header class="major">
										...
										<div class="major-actions">
											<a href="/blog-details" class="button small next scrolly">Read Blog</a>
										</div>
									</header>
								</article>
								<article>
...
</html><?php /**PATH C:\Xampp\htdocs\gotravid-laravel\resources\views/index.blade.php ENDPATH**/ ?>